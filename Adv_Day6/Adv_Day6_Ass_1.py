...
member1 = LibraryMember("Jyoti")
member2 = LibraryMember("Ashwita")
...
Jyoti has borrowed Python Programming
Book not available.
Total Books: 3
Available Books: Data Structures, Machine Learning, AI Basics
Jyoti has returned Python Programming
Ashwita has not borrowed Data Structures
Total Books: 4
