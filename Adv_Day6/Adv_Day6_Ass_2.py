...
'''Output'''
"""Inception has been borrowed by Jyoti
The Matrix is not available in the library
Jyoti has borrowed: ['Inception']
Inception has been returned to the library by Jyoti
Titanic was not borrowed by Jyoti
Jyoti has borrowed: []"""